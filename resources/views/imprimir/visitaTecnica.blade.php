...
<body>
    <table>
        ...
        <tr>
            ...
            <td><label>Quantidade de Estudantes Adicionados:</label> <span style="background-color: {{ $visitaTecnica->qtd_estudantes != $visitaTecnica->discenteVisitas->count() ? '#f3adab' : '' }}">{{$visitaTecnica->discenteVisitas->count()}}</span></td>
        </tr>
        <tr>
    </table>
    <br>
